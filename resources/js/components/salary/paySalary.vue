		...
		<div class="col-xl-12 col-lg-12 col-md-12">
			<div class="card shadow-sm my-5">
				<div class="card-body p-0">
					<div class="row">
						<div class="col-lg-12">
							<router-link to="/given-salary" class="btn btn-primary float-right" style="margin-top: 6px;margin-right: 6px;">Ajout salaire</router-link>
							<div class="login-form">
								<div class="text-center">
									<h1 class="h4 text-gray-900 mb-4">Paiement de salaire</h1>
								</div>
									...
									<div class="form-group">
										<div class="form-row">
											<div class="col-md-6">
												...
												<input disabled type="number" class="form-control" id="exampleInputSalary" placeholder="Salaire" v-model='form.salary'>
