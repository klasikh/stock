	...
	<div>
		<div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Point de vente</h1>
            <ol class="breadcrumb">
          ...
          <div class="row mb-3">
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  	<h5 class="m-0 font-weight-bold text-primary">Panier des achats</h5>
                	<router-link class="btn btn-primary btn-sm" to="/store-customer">Ajouter client</router-link>
                  <!-- <a href="/store-customer">Ajouter client</a> -->
                </div>
                <div class="card-body">
                	...
                	<div class="order-md-2 mb-4">
                		<ul class="list-group mb-3">
                			<li class="list-group-item d-flex justify-content-between lh-condensed">
                				<div>
                					<h6 class="my-0">Quantité totale</h6>
                				</div>
                				<span class="text-muted">{{ qty }}</span>
                			</li>
                			<li class="list-group-item d-flex justify-content-between lh-condensed">
                				<div>
                					<h6 class="my-0">Montant total</h6>
                				</div>
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h5 class="m-0 font-weight-bold text-primary">Produits</h5>

                  <input type="search" placeholder="Rechercher" v-model="searchTerm" class="form-control" style="width: 300px;">
                </div>
                					...
                					<div class="card" style="align-items: center; margin-bottom: 10px">
                						<button class="btn btn-sm" @click.prevent="addToCart(product.id)">
                							...
                							<div class="card-body">
                								...
                								<td v-if="product.product_quantity >= 1"><span class="badge badge-success">Disponible <span class="badge badge-light">{{ product.product_quantity }}</span></span></td>
                					...
                					<div class="card" style="align-items: center; margin-bottom: 10px">
                						<button class="btn btn-sm" @click.prevent="addToCart(catProduct.id)">
                							...
                							<div class="card-body">
                								...
                								<td v-if="catProduct.product_quantity >= 1"><span class="badge badge-success">Disponible <span class="badge badge-light">{{ catProduct.product_quantity }}</span></span></td>
                								<td v-else=""><span class="badge badge-danger">Stock Out</span></td>
                							</div>
                						</button>
                					</div>
