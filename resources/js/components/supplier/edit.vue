		...
		<div class="col-xl-12 col-lg-12 col-md-12">
			<div class="card shadow-sm my-5">
				<div class="card-body p-0">
					<div class="row">
						<div class="col-lg-12">
							<router-link to="/supplier" class="btn btn-primary float-right" style="margin-top: 6px;margin-right: 6px;">Liste des forunisseurs</router-link>
							<div class="login-form">
								<div class="text-center">
									<h1 class="h4 text-gray-900 mb-4">Editer les infos du forunisseur</h1>
								</div>
